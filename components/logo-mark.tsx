// Chord-diagram logo mark ("G7 Logo"), sourced from the Figma file
// (node 94:86, "Guitar Chord Theory - UI") on 2026-09-08. Colors match the
// app's ink (#37302a, see globals.css --heading-grad-start) and the
// Chord Finder tab's terracotta accent (#bf6f4a, see lib/tab-theme.ts).
export default function LogoMark({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 52 61.18" className={className} xmlns="http://www.w3.org/2000/svg">
